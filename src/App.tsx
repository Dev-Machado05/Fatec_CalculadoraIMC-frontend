...
import { calculator, help, reload } from "ionicons/icons";
import Calculate from "./pages/Calculate";
import History from "./pages/History";
import Help from "./pages/Help";
import Result from "./pages/Result";
import ChildImc from "./pages/ChildImc";
import ImcInfo from "./pages/ImcInfo";
    ...
    <IonReactRouter>
      <IonTabs>
        <IonRouterOutlet>
          ...
          <Route exact path="/childImc">
            <ChildImc />
          </Route>
          <Route exact path="/ImcInfo">
            <ImcInfo />
          </Route>
